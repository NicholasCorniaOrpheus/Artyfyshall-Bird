...
\include "./foppa-bottega_caffe-1801.ly"
  ...
  %! abjad.LilyPondFile._get_format_pieces()
{
    ...
    <<
    %Voice1 part
    \context Voice = "voiceone" \with { instrumentName = "Canto Primo" }
    <<
    ...
    \new Lyrics \lyricsto voiceone \lyrics_one
    >>
    %Voice2 part
    \context Voice = "voicetwo" \with { instrumentName = "Canto Secondo" }
    <<
    \set Staff.midiInstrument =#"voice oohs" {
    \include "../voice_option.ly"
    ...
    \new Lyrics \lyricsto voicetwo \lyrics_two
