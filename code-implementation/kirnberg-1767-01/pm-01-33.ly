...
\include "./violin1/pm-01-vln1-33.ly"
}  
    ...
    \include "voice_option.ly"
\include "./violin2/pm-01-vln2-33.ly"
}  
    ...
    <<
       ...
       \context Staff = "rh" {
         ...
         \include "voice_option.ly"
<<{\include "./violin1/pm-01-vln1-33.ly" } \\ { \include"./violin2/pm-01-vln2-33.ly" } >>
}
        
        \context Staff = "lh" {
         \set Staff.midiInstrument =#"harpsichord"
         \include"bassline_option.ly"
\include "./lh/pm-01-lh-33.ly"
}
